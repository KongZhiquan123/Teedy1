pipeline { 
    ...
    environment { 
        ...
        DOCKER_IMAGE = 'kongzhiquan/teedy' // your Docker Hub user name and Repository's name 
        ...
        stage('Build') { 
            steps { 
                checkout scmGit( 
                    ...
                    extensions: [],  
                    userRemoteConfigs: [[url: 'https://github.com/KongZhiquan123/Teedy1.git']] // your GitHub Repository 
                ) 
